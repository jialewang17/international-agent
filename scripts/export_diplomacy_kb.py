...
# 源 Excel 路径：设置环境变量 DIPLOMACY_XLSX，或修改下方默认值
_DEFAULT_SRC = Path(r"D:\大创\1021AIGC中国故事材料") / "回复参考-主题参考的外交部发言_20230610(1).xlsx"
SRC = Path(os.environ.get("DIPLOMACY_XLSX", str(_DEFAULT_SRC)))
OUT_DIR = get_project_root() / "knowledge" / "diplomacy"
